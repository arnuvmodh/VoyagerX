...
public class FiveSamplePartnerPark extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory traj2 = drive.trajectoryBuilder(traj1.end())
                .lineToSplineHeading(new Pose2d(-9.75, 13.6583, 1.5808))
                .build();
            ...
            switch (curState) {
                ...
                case traj2:
                    if (oneTimeSwitch[1] && timer.seconds() > 0.5) {
                        ...
                        horizontalSlidePosition = 0.225;
                        robot.spintake.spinIn(1);
                        oneTimeSwitch[1] = false;
                    }
                    if (timer.seconds() > 1.2 && timer.seconds() < 1.6) {
                        intakeGrab();
                    }
                    ...
                    if(timer.seconds()>1.7&&timer.seconds()<2.9) {
                        intakeFlipIn();
                    }
                ...
                case traj8:
                    ...
                    if (timer.seconds() > 1 && timer.seconds() < 1.6) {
                        intakeGrab();
                    }
