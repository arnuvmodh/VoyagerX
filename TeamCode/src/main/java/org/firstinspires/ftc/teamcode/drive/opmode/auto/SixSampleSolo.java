...
public class SixSampleSolo extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory traj2 = drive.trajectoryBuilder(traj1.end())
                .lineToSplineHeading(new Pose2d(-8.5, 13.6583, 1.5808))
                .build();
        ...
        Trajectory traj8 = drive.trajectoryBuilder(traj7.end())
                .splineToLinearHeading(new Pose2d(17.5, 60, 6.2498),0)
                .build();
            ...
            switch (curState) {
                ...
                case traj8:
                    if(!fifthIntakeSuccess) {
                        if (oneTimeSwitch[15] && timer.seconds() > 2) {
                            horizontalSlidePosition = 0.2;
                            intakeFlipOut();
                ...
                case traj10:
                    if(!sixthIntakeSuccess) {
                        if (oneTimeSwitch[18] && timer.seconds() > 2) {
                            horizontalSlidePosition = 0.2;
                            intakeFlipOut();
